...
HD_PWD='C:/Users/janit/OneDrive/Desktop/Vivado/Nanoprocessor - Additional Features/Nanoprocessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainProgram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainProgram.tcl -notrace
